...
choco install -y --no-progress vcredist2010 ninja nsis

echo ==> Installing python dependencies...
py -3 -mpip install -U pip
py -3 -mpip install PyQt5 six requests semantic_version pypiwin32 comtypes pyinstaller ninja-syntax etaprogress
