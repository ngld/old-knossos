...
echo __ Installing Chocolatey...
powershell -NoProfile -ExecutionPolicy Bypass -Command "iex ((New-Object System.Net.WebClient).DownloadString('https://chocolatey.org/install.ps1'))"
SET "PATH=%PATH%;%ALLUSERSPROFILE%\chocolatey\bin"

echo __ Installing packages...
...
sha256deep -m py.hash py3inst.exe > NUL
if errorlevel 1 (
...
echo __ Installing python dependencies...
...
echo __ Downloading remaining dependencies...
