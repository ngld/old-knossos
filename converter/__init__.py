...
def generate_checksums(repo, output, prg_wrap=None, dl_path=None, dl_mirror=None, dl_slug=None, curses=False, force_cache=False, list_files=False, remove_prefixes=[]):
    ...
    if len(items) < 1:
        ...
        init_app()
        task = ChecksumTask(items, dl_path, dl_mirror, dl_slug, remove_prefixes)
